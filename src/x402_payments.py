...
def create_solana_x402_handler(
    ...
    This handler automatically signs 402 Payment Required responses,
    enabling the AceDataCloud SDK to transparently pay per request.

    Args:
        private_key_b58: Optional Solana base58 private key.

    Returns:
        A payment_handler callable compatible with AceDataCloud client.
    """
